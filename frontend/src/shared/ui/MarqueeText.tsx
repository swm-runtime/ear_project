...
/**
 * 한 줄 제목 — 폭에 다 들어가면 그대로, 넘치면 왼쪽으로 흘러 끝을 보여준다(2026-09-16). **웹 판**(SVG) —
 * iOS·Android 는 `MarqueeText.native.tsx`(MaskedView + 네이티브 드라이버, 2026-09-26). 이 판은 JS 드라이버라 흐르는 동안 JS 를 쓴다.
 *
