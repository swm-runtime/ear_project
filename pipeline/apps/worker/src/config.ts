...
export const cfg = {
  ...
  /** 프롬프트 자산 루트 (읽기 전용) — 기본: 레포의 docs/ai (skills/·spec/ 가 여기 있다) */
  assetRoot: process.env.ASSET_ROOT || path.resolve(here, "..", "..", "..", "..", "docs", "ai"),
  ...
  promptVersion: process.env.PROMPT_VERSION || "full-v5.1",
};
