...
## 처리 기록 (반영 날짜 2026-08-26 — 브랜치 `feat(be)/social-login`)

- **`auth-api.md` 4.1에 "provider_token — 제공자별 형식" 절을 신설**해 4종 형식과 검증 수단을 확정 기재했다. Request 예시의 `"인증 코드 또는 액세스 토큰"`도 걷어냈다.
