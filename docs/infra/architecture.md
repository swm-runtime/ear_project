...
- 애플리케이션 레벨(5xx율·헬스) 알람 없음 — 지표는 있으나 알람은 EC2 상태 검사 1개. Slack 알림(ERROR 감시·자원 임계·백업 실패)은 전부 "자기 보고"라 서버가 죽으면 조용하다. **외부 헬스체크·백업 심장박동 알람은 KAN-62 5단계에서 미결로 보류(2026-09-15)**.
