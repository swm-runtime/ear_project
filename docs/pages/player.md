...
> 연결 PRD: FR-23, FR-24, FR-25, FR-12, FR-15, FR-33 / 비기능(재생 즉시성) / 사용자흐름 5.2
...
- **선행 조건**: 차감이 발생하는 재생이면 **재생 확인 팝업에서 [재생하기]를 누른 뒤**에 열린다(`library.md` 4.3). 팝업은 라이브러리가 띄우며 플레이어는 통과한 요청만 받는다.
