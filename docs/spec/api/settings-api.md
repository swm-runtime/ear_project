...
설정 > 정보 > [공지사항]의 목록(신설 2026-09-17 — `changes/pending/notice-screen-spec.md` C, KAN-67). 운영 공지 게시판이며 **점검 공지(`domain.md` 13.3)와 별개**다.
...
- ~~공지사항의 형태~~ → **형태는 확정(2026-08-06): 인앱 화면**(`settings.md` 4.1). ~~목록 API~~ → **확정(2026-09-17): 4.4·4.5**(`changes/pending/notice-screen-spec.md` C, KAN-67).
